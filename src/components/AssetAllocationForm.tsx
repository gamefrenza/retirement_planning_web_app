...
const AssetAllocationForm: FC = () => {
  const { assets, setAssets } = useRetirement();
  
  const [totalAmount, setTotalAmount] = React.useState<number>(assets.totalAmount);
  const [cashPercentage, setCashPercentage] = React.useState<number>(assets.allocation.cash);
  const [bondsPercentage, setBondsPercentage] = React.useState<number>(assets.allocation.bonds);
  const [equityPercentage, setEquityPercentage] = React.useState<number>(assets.allocation.equity);
